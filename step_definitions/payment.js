...
//     registerPage.navigateToPayment();
//   });

//   When('the user clicks on generate Card Number', async function () {
//     registerPage = new RegisterPage(driver);
//     registerPage.navigateTogenerateCardNumber();
...
//     registerPage =new RegisterPage(driver);
//     registerPage.navigateToCart();
//   });

//   When('the user select the numberOfItems', async function () {
//     registerPage =new RegisterPage(driver);
//     registerPage.addQuantity();

//   });

//   When('the user clicks on BuyNow Button', function () {
//     registerPage =new RegisterPage(driver);
//     registerPage.clickOnBuyButton();

//   });

//   When('the user enters the card number as {string}', function (string) {
//     registerPage.sendKeys();

//   });

//   When('the user select expiration month as {string}', function (string) {
//    registerPage.sendKeys();
//   });

//   When('the user select expiration year as {string}', function (string) {
//     // Write code here that turns the phrase above into concrete actions
//     return 'pending';
//   });

//   When('the user enter CVV codes as {string}', function (string) {
//     // Write code here that turns the phrase above into concrete actions
//     return 'pending';
//   });

//   When('the user clicks on PayButton', function () {
//     // Write code here that turns the phrase above into concrete actions
//     return 'pending';
//   });
...
// When('the user select expiration month as {string}', async function (month) {
//     await registerPage.selectExpirationMonth(month);
// });
